...
barplot(std2$total, names.arg=std2$County, las=2, cex.names=0.5, col=mycols, 
...
barplot(fl2$x1524per, names.arg=fl2$county, las=2, cex.names=0.5, col=mycols3,
...
barplot(std4$adjper, names.arg=std4$County, las=2, cex.names=0.6,border=FALSE, col=mycols, 
