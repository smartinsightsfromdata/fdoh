...
#READ IN DATA
setwd("E:/workingdirectory/mosquito")
...
nov04 <- read.csv("2013-11-04.csv", skip=4, header=T, sep=",")
nov12 <- read.csv("2013-11-12.csv", skip=4, header=T, sep=",")
nov26 <- read.csv("2013-11-26.csv", skip=4, header=T, sep=",")
...
names(nov04)[1] <- "site"
names(nov04)[12] <- "total"
nov04 <- nov04[-34,]
nov04$Code.. <- NULL
nov04$date <- as.Date("2013-11-04")
nov04 <- nov04[-c(34:90),]
nov04 <- nov04[,-c(13:21)]

names(nov12)[1] <- "site"
names(nov12)[12] <- "total"
nov12 <- nov12[-34,]
nov12$Code.. <- NULL
nov12$date <- as.Date("2013-11-12")
nov12 <- nov12[-c(34:90),]
nov12 <- nov12[,-c(13:21)]

names(nov26)[1] <- "site"
names(nov26)[12] <- "total"
nov26 <- nov26[-34,]
nov26$Code.. <- NULL
nov26$date <- as.Date("2013-11-26")
nov26 <- nov26[-c(34:90),]
nov26 <- nov26[,-c(13:21)]
...
save.image("E:/workingdirectory/mosquito/mosq04nov13.RData")
