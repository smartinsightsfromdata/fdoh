...
jour <- c(1:15) #Change this in function of the number of total collections...
jour2 <-jour*2
...
points(traplatlong$long, traplatlong$lat,
       ...
       cex=1.2*(cexwnvsep17/wnvbl))
text(traplatlong$long, traplatlong$lat, 
     labels=names,
     cex=0.4,
     adj=c(0.5,2),
     las=3)
title("West Nile vectors")
legend(-82.7,29.46,
       ncol=1,
       legend=c("below normal", "normal", 
                "above normal"),
...
points(traplatlong$long, traplatlong$lat,
       ...
       cex=1.2*(cexmalariasep17/malariabl))
text(traplatlong$long, traplatlong$lat, 
     labels=names,
     cex=0.4,
     adj=c(0.5,2),
...
points(traplatlong$long, traplatlong$lat,
       ...
       cex=1.2*(cexdenguesep17/denguebl))
text(traplatlong$long, traplatlong$lat, 
     labels=names,
     cex=0.4,
     adj=c(0.5,2),
