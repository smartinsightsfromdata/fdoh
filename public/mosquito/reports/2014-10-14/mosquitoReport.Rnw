...
As predicted, mosquito numbers remained low over recent weeks, ranging from 105 per trap on September 23rd to 131 per trap at the most recent collection date (\Sexpr{format(recent, format="%B %d, %Y")}).  
