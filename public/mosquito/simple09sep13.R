...
points(traplatlong$long, traplatlong$lat,
       ...
       cex=1.2*(cexmalariasep03/malariabl))
text(traplatlong$long, traplatlong$lat, 
     labels=names,
     cex=0.4,
     adj=c(0.5,2),
...
points(traplatlong$long, traplatlong$lat,
       ...
       cex=1.2*(cexdenguesep03/denguebl))
text(traplatlong$long, traplatlong$lat, 
     labels=names,
     cex=0.4,
     adj=c(0.5,2),
